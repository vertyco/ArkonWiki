...
Arkon collects some amount of data about users for the bots normal operation. 
...
This data is not stored on the bot and is instead only passed between the channel and ark server.
